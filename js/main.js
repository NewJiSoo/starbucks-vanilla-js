...
// 300이면 0.3초, 0.3초 단위로 부하를 줘서 함수가 우르르 실행되는 것을 방지하는 용도
// 밀리 세컨드 단위
// _.throttle(함수, 시간)
...
promotionToggleBtn.addEventListener('click', function () {
    isHidePromotion = !isHidePromotion // True면 Flase가 되고, False면 True가 됨
    if (isHidePromotion) {
        // 숨김처리
...
function floationgObject(selector, delay, size) {
    ...
    gsap.to(selector, // 선택자
        ...
        {  // 옵션
            ...
            repeat: -1, // 무한 반복
            yoyo: true,
            ease: Power1.easeInOut, // https://gsap.com/docs/v3/
